package ru.kpfu.itis.lobanov.servlets.control1.servlet;

import com.google.gson.Gson;
import ru.kpfu.itis.lobanov.servlets.control1.model.dao.impl.AppointmentDao;
import ru.kpfu.itis.lobanov.servlets.control1.model.dao.impl.MasterDao;
import ru.kpfu.itis.lobanov.servlets.control1.model.dao.impl.ServiceDao;
import ru.kpfu.itis.lobanov.servlets.control1.model.entity.Appointment;
import ru.kpfu.itis.lobanov.servlets.control1.model.entity.Master;
...
public class MainServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String s = ZonedDateTime.now().toString();
        String[] dateInput = ZonedDateTime.now().toString().split("T"); //2023-10-22T21:10:13.885+03:00[Europe/Moscow]
        String[] timeInput = dateInput[1].split("\\.");
        String stringDate = dateInput[0];
        String stringTime = timeInput[0];
        Timestamp date = Timestamp.valueOf(stringDate + " " + stringTime);
