package ru.kpfu.itis.lobanov.fxml.controller;
...
import ru.kpfu.itis.lobanov.fxml.model.User;
...
public class PageController {
    ...
    public PageController() {
        ...
        userList.add(new User("Stepan", 10));
        userList.add(new User("Gregory", 90));
    }
